...
bool UserLogin::connectMySql()
{
	...
	db.setPassword("zhou1zhou2");				// 数据库，密码
...
bool UserLogin::veryfyAccountCode(bool& isAccountLogin, QString& strAccount)
{
	...
	QString strSqlCode = QString("SELECT code FROM qtqq.tab_accounts WHERE employeeID = %1")
		.arg(strAccountInput);
	...
	strSqlCode = QString("SELECT code,employeeID FROM qtqq.tab_accounts WHERE account = '%1'")
		.arg(strAccountInput);
